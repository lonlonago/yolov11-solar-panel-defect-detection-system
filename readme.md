# YOLOv11 Solar Panel Defect Detection System

## Body

YOLOv11 Solar Panel Defect Detection System Based on Deep Learning YOLOv11's Infrared Solar Panel Defect Identification Detection System (YOLOv11+YOLO dataset + UI interface + login registration interface + Python project source code + model)

nc: 4 classes,
Name: ['Bypass Diode', 'Cell Fault', 'Defects', 'Hotspot'],
Dataset quantity: training set 1897 images, validation set 222 images, test set 113 images.
